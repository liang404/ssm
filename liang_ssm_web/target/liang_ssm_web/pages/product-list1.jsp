                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="删除" onclick="check()"><i class="fa fa-trash-o"></i> 删除</button>
...
<script type="text/javascript">
    function check() {
        ...
        if (check_val==null){
            ...
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/product/delete.do?ids="+check_val,
